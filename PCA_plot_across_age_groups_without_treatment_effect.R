...
screeplot(p)
biplot(p)
biplot(p, colby = 'age', shape = 'age')
biplot(p, colby = 'age', colkey = c(Adult = 'blue', Kid = 'red'),
       legendPosition = 'right', showLoadings = T, showLoadingsNames = T)

biplot(p, x = 'PC1', y = 'PC2', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

biplot(p, x = 'PC1', y = 'PC4', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

biplot(p, x = 'PC4', y = 'PC1', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

biplot(p, x = 'PC10', y = 'PC9', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

biplot(p, x = 'PC10', y = 'PC8', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

biplot(p, x = 'PC8', y = 'PC10', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

biplot(p, x = 'PC10', y = 'PC7', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

biplot(p, x = 'PC10', y = 'PC6', colby = 'age', colkey = c(Adult='blue', Kid='red'),
       shape = 'age', shapekey = c(Adult=10, Kid=21), legendPosition = 'right',
       pointSize = 3, encircle = T, ellipse = F, labSize = 3, labhjust = 0.7, labvjust = 0.5)

p$components

pairsplot(p, triangle = F, shape = 'age', pointSize = 3,
          legendPosition = 'bottom', axisLabSize = 6, vline = c(0,0), hline = c(0,0),
          title = paste('PCA pairsplot for ', testgroup), titleLabSize = 12, colby = 'age',
          colkey = c(Adult = 'blue', Kid = 'red'))
